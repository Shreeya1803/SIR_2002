...
To share the app beyond your local network:

1. Deploy the Flask backend to [Railway](https://railway.app) or [Render](https://render.com)
2. Update `BASE_URL` in `src/api.js` to the public URL
...
> **Note:** For production deployment, consider switching from SQLite to PostgreSQL for better concurrency and reliability.
